...
message(STATUS "USE VCG DIR: ${VCG_INCLUDE_DIR}/")
add_subdirectory("${VCG_INCLUDE_DIR}/")
if (VCG_INCLUDE_DIR AND NOT EIGEN3_INCLUDE_DIR)
    set(EIGEN3_INCLUDE_DIR "${VCG_INCLUDE_DIR}/eigenlib/" CACHE INTERNAL "Eigen3 Path" )
    message(STATUS "VCG EIGEN3_INCLUDE_DIR: ${EIGEN3_INCLUDE_DIR}")
endif()
